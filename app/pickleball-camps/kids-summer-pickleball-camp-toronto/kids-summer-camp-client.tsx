...
export default function KidsSummerCampClient() {
  ...
  const camp = {
    ...
    totalPrice: "Full 15-day program also available",
            ...
            <section>
              ...
              <div className="prose prose-muted max-w-none">
                <p className="text-muted-foreground leading-relaxed">
                  Breakaway Pickleball Camps and <a href="https://baselinerec.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary transition-colors">Baseline Rec Pickleball League</a>{" "}are teaming up for a summer camp like no other -- a 3-week youth program running August 17 to September 4 at The Jar PickleBall Club in Toronto. Designed for ages 8-14, all skill levels are welcome and no experience is required. This isn&apos;t babysitting with paddles -- it&apos;s structured, skill-based development led by experienced youth coaches in a high-energy, inclusive environment. With just 36 campers per day across 6 dedicated courts, your child gets real attention, real reps, and real growth. Choose the days and weeks that work best for your family&apos;s schedule -- spots are limited and will fill quickly.
                </p>
              </div>
            </section>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-border p-4 shadow-lg z-50">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <div className="text-xs text-muted-foreground">{camp.priceNote}</div>
          </div>
