...
export default function TorontoBeginnerCampClient() {
  ...
  const camp = {
    ...
    checkoutUrl: "https://book.stripe.com/bJebJ10NegTl0Y63hUf3a05",
    coachBio:
    ...
    curriculum: [
      {
        day: "Day 1",
        sessions: [
          { time: "9:00 AM", activity: "Intro & Camp Flow\nDynamic warm up and orientation" },
          { time: "9:30 AM", activity: "Net Play\nSoft game fundamentals and dinking technique" },
          { time: "11:30 AM", activity: "Lunch & Video Analysis\nMeal break with game review (lunch 11:30-12:30)" },
          { time: "12:30 PM", activity: "Drives & Drops\nBuilding reliable shot selection and consistency" },
          { time: "1:30 PM", activity: "Game Play\nApplying concepts in live match situations" },
          { time: "3:00 PM", activity: "Day 1 Complete" },
        ],
      },
      {
        day: "Day 2",
        sessions: [
          { time: "9:00 AM", activity: "Recap & Camp Flow\nDay 1 review and warm up" },
          { time: "9:30 AM", activity: "Smashes & Defending Smashes\nOffensive and defensive overhead techniques" },
          { time: "11:30 AM", activity: "Lunch\nMeal break" },
          { time: "12:30 PM", activity: "Court Positioning\nUnderstanding where to be and when to move" },
          { time: "1:00 PM", activity: "Tournament\nCompetitive match play with prizes" },
        ],
      },
    ],
  }
