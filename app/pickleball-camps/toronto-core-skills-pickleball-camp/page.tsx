...
export const metadata: Metadata = {
  ...
  description: "A premium core skills pickleball camp in Toronto for 2.75-3.0 players. Small groups, pro coaching, and focused on building strong fundamentals.",
  alternates: {
